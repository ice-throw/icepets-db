...
class WishlistsControllerTest < ActionController::TestCase
  ...
  test "should create wishlist" do
    assert_difference('Wishlist.count') do
      post :create, wishlist: { description: @wishlist.description, name: @wishlist.name, privacy: @wishlist.privacy, sorting: @wishlist.sorting, user_id: @wishlist.user_id }
    end
  ...
  test "should update wishlist" do
    patch :update, id: @wishlist, wishlist: { description: @wishlist.description, name: @wishlist.name, privacy: @wishlist.privacy, sorting: @wishlist.sorting, user_id: @wishlist.user_id }
    assert_redirected_to wishlist_path(assigns(:wishlist))
  end
